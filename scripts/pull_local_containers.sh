...
Environment overrides:
  ...
  FIMTYPER_CONTAINER_URI    default: docker://ghcr.io/sethiyap/agar-bactopia-fimtyper:1.0
EOF
}
...
fimtyper_uri="${FIMTYPER_CONTAINER_URI:-docker://ghcr.io/sethiyap/agar-bactopia-fimtyper:1.0}"
